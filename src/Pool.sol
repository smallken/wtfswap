...
contract Pool is IPool {
    ...
    function mint(
        ...
        console.log("pool mint fun.");
        console.log("amount:", amount/10**18);
        console.log("amount0:", amount0/10**18);
        console.log("amount1:", amount1/10**18);
        uint256 balance0Before;
        uint256 balance1Before;
        if (amount0 > 0) balance0Before = balance0();
        if (amount1 > 0) balance1Before = balance1();
         console.log("amount1:", amount1/10**18);
        console.log("in pool mint fun,before mintcallback");
        // 回调 mintCallback
        IMintCallback(msg.sender).mintCallback(amount0, amount1, data);
        console.log("in pool mint fun,after mintcallback");
        console.log("balance0Before:",balance0Before);
        console.log("balance0Before.add(amount1):", balance0Before.add(amount0));
        console.log("balance1Before:",balance1Before);
        console.log("balance1Before.add(amount1):", balance1Before.add(amount1));
